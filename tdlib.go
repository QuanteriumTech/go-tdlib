...
//#cgo darwin LDFLAGS: -L/usr/local/lib/td -ltdjson_static -ltdjson_private -ltdclient -ltdcore -ltdactor -ltddb -ltdsqlite -ltdnet -ltdutils -lstdc++ -lssl -lcrypto -ldl -lz -lm//#cgo windows LDFLAGS: -LC:/src/td/build/Debug -ltdjson
//#include <stdlib.h>
...
func (client *Client) SendPhoneNumber(phoneNumber string) (AuthorizationState, error) {
	pnAuthSettings := &PhoneNumberAuthenticationSettings{
		AllowFlashCall: false,
	}
	_, err := client.SetAuthenticationPhoneNumber(phoneNumber, pnAuthSettings)
